...
{
    public class DaprPlacementSidecarHostedServiceTests
    {
        public class OnStarting
        {
            ...
            public async Task Should_wait_for_sidecar()
            {
                ...
                var logger = Substitute.For<ILogger<DaprPlacementSidecarHostedService>>();
                var hostedService = new DaprPlacementSidecarHostedService(sidecarHost, host, optionsAccessor, logger);

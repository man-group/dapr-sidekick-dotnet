// Based on https://github.com/dotnet/extensions/blob/release/2.1/src/Logging/Logging.Abstractions/src/Internal/LogValuesFormatter.cs
...
namespace Dapr.Sidekick.Logging.Internal
{
    ...
    /// </summary>
    internal class DaprLogValuesFormatter
    {
        ...
        public DaprLogValuesFormatter(string format)
        {
        ...
        private object FormatArgument(object value)
        {
            ...
            {
#if NET35
                return string.Join(", ", enumerable.Cast<string>().Select(o => o ?? NullValue).ToArray());
#else
